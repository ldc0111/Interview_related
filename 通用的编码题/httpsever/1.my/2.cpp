/*************************************************************************
	...
	> Author: 
	> Mail: 
	> Created Time: 2020年03月28日 星期六 11时01分40秒
 ************************************************************************/
...
#include<sys/epoll.h>
#include<map>
#include"1.threadpool.h"
#include"1.myhttp_coon.h"
using namespace std;
const int port = 8888;
...
int main(int argc, char *argv[])
{
    ...
    while(true)
    {
        ...
        http_coon* users = new http_coon[number];
        assert(users);
