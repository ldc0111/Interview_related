/*************************************************************************
	> File Name: 1.myhttp_coon.h
	> Author: 
	> Mail: 
	> Created Time: 2020年03月28日 星期六 10时20分09秒
 ************************************************************************/
...
bool http_coon::bad_respond()//400
{
    ...
    sprintf(filename,"/home/tesla/programming/github/Interview_related/通用的编码题/httpsever/1.my/%s",url);
    struct itat my_file;
...
{
    char path[200]="/home/tesla/programming/github/Interview_related/通用的编码题/httpsever/1.my";
    char* ch;
    cout << url << endl;
    if(ch=strchr(url,'?'))
    {
