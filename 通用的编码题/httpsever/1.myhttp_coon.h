...
bool http_coon::bad_respond()//400
{
    ...
    sprintf(filename,"/home/tesla/programming/github/Interview_related/通用的编码题/httpsever/%s",url);
    struct stat my_file;
...
{
    char path[200]="/home/tesla/programming/github/Interview_related/通用的编码题/httpsever";
    char* ch;
    cout << url << endl;
    if(ch=strchr(url,'?'))
    {
